...
export function ModalProductAddUpdate({visible,onClose,edit=false,product}) {

    const dispatch = useDispatch();
    const [loader,setLoader] = useState(false)
    const saveProductData = useSelector((state)=>state.saveProductSlice.product);
    const updateProductData = useSelector((state)=>state.updateProductSlice.product)
